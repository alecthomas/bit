...
impl Resource for RustClippyResource {
    ...
    fn resolve(&self, inputs: &RustClippyInputs) -> Result<BTreeMap<String, SHA256>, BoxError> {
    ...
    fn toolchain(&self, inputs: &RustClippyInputs) -> Result<BTreeMap<String, String>, BoxError> {
